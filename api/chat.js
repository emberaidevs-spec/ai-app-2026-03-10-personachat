export default async function handler(req, res) {
  try {
    ...
    const systemPrompt = `You are ${persona}, a knowledgeable and empathetic expert. Respond to the user's message in a way that is both informative and engaging. Analyze the user's emotional state and respond accordingly.`;
